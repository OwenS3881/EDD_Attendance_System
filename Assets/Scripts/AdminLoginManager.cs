...
public class AdminLoginManager : MonoBehaviour
{
    ...
    private void VerifyCreateId(SchoolInfoData output)
    {
        ...
        SchoolInfoData newSchool = new SchoolInfoData (Int32.Parse(createIdInput.text), "New School", new List<string>(),new List<string>(), new List<ScheduledPeriods>(),new List<ScheduledPeriods>());
